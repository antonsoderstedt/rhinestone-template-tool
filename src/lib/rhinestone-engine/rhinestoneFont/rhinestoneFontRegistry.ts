...
export const RHINESTONE_FONT_REGISTRY: readonly RhinestoneFontDefinition[] = [
  ...
  },
  {
    ...
    isPrivate: true,
    supportedTargetStoneSizeIds: ['SS10'],
    limitations: ['Sized for SS10 package', 'Coverage depends on bundled asset'],
  },
  {
    fontId: 'bride-ss10',
    displayName: 'Bride SS10',
    category: 'Library',
    style: 'Script',
    suggestedText: 'Bride',
  ...
  },
  {
    ...
    isPrivate: true,
    supportedTargetStoneSizeIds: ['SS10'],
    limitations: ['Digits-focused package', 'Sized for SS10 package'],
    characterCoverage: {
      uppercase: false,
      lowercase: false,
      digits: true,
